...
<!doctype html>
        ...
        <div class="container">
            ...
            <div class="row">
              <div class="col bg text-left pt-4" >
                <h4>Minhas comunicações <span class="badge badge-warning"><?php print strtolower($login) . " | " . mysql_result($getUserDept,0); ?></span></h4>
 ...
 <?php                       
        ...
        FROM
               COMUNICACAO
        WHERE
               USER_ID = " . mysql_result($getUserId,0) . " AND STATUS='A' ORDER BY DATA DESC,ID");
